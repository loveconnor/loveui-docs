...
export default function LogoCloud() {
  return (
    <section className="@container bg-background py-12">
      <div className="mx-auto max-w-xl px-6">
        <div className="grid grid-cols-3 gap-x-8 gap-y-12 *:flex *:items-center *:justify-center **:fill-foreground @xl:grid-cols-4">
          <div>
