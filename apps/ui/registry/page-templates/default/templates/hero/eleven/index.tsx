                    ...
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-20">
                        <div className="lg:flex lg:items-center lg:gap-12">
                            <div className="relative z-10 mx-auto max-w-xl text-center lg:ml-0 lg:w-1/2 lg:text-left">
                                ...
                                <h1 className="mt-10 text-balance text-4xl font-bold md:text-5xl xl:text-5xl">Production-ready UI blocks for modern teams</h1>
                                <p className="mt-8">LoveUI helps teams ship polished interfaces faster with accessible components, flexible theming, and production-ready patterns.</p>
