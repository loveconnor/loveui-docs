...
const Example = () => (
  <DialogStack>
    ...
    <DialogStackBody>
      ...
      <DialogStackContent>
        <DialogStackHeader>
          <DialogStackTitle>Updated I'm the fourth dialog</DialogStackTitle>
          <DialogStackDescription>
            Updated With a fancy description
          </DialogStackDescription>
        </DialogStackHeader>
      ...
      <DialogStackContent>
        <DialogStackHeader>
          <DialogStackTitle>Updated I'm the fifth dialog</DialogStackTitle>
          <DialogStackDescription>
            Updated With a fancy description
          </DialogStackDescription>
        </DialogStackHeader>
      ...
      <DialogStackContent>
        <DialogStackHeader>
          <DialogStackTitle>Updated I'm the sixth dialog</DialogStackTitle>
          <DialogStackDescription>
            Updated With a fancy description
          </DialogStackDescription>
        </DialogStackHeader>
