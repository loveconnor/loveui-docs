...
import { getTemplateCategories } from "@/lib/page-templates/registry"
...
export default function Page() {
  ...
  return (
    <div data-home className="flex-1">
      <PageHeader className="border-b border-border/60 bg-background">
        <div className="px-4 text-center sm:px-6 lg:px-10">
          <div className="mx-auto max-w-3xl space-y-6">
            <span className="inline-flex items-center gap-2 rounded-full border border-border/60 bg-background px-4 py-1 text-xs font-medium tracking-[0.28em] text-muted-foreground uppercase">
              Templates Library
            </span>
            <PageHeaderHeading className="text-balance text-foreground">
              Build complete templates in minutes.
            </PageHeaderHeading>
            <PageHeaderDescription className="text-balance text-muted-foreground">
              Explore production-ready templates crafted for modern dashboards,
              marketing sites, and internal tools.
            </PageHeaderDescription>
      ...
      <section className="container px-4 pt-12 pb-24 sm:px-6 lg:px-10">
