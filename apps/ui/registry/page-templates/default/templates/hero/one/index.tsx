                            ...
                            <div className="mx-auto mt-24 max-w-xl">
                                <div className="grid scale-95 grid-cols-3 gap-12">
                                    <div className="ml-auto blur-[2px]">
                                        <Card className="shadow-foreground/10 flex h-8 w-fit flex-row items-center gap-2 rounded-xl px-3 py-0 sm:h-10 sm:px-4">
                                    ...
                                    <div>
                                        <Card className="shadow-foreground/10 mx-auto flex h-8 w-fit flex-row items-center gap-2 rounded-xl px-3 py-0 sm:h-10 sm:px-4">
