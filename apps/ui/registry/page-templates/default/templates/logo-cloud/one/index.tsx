  ...
  return (
    <section className="bg-background py-16">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="mx-auto mt-20 flex max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-8 *:flex *:items-center *:justify-center **:fill-foreground sm:gap-x-16 sm:gap-y-12">
          <div>
