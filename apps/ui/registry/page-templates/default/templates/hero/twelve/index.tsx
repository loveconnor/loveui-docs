                        ...
                        <div className="mx-auto max-w-7xl px-6 md:px-12">
                            <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                                ...
                                <h1 className="mt-8 text-4xl font-semibold md:text-5xl xl:text-5xl xl:[line-height:1.125]">
                                    Tame the Wild West <br /> of UI Development
                                </h1>
                                <p className="mx-auto mt-8 hidden max-w-2xl text-wrap text-lg sm:block">LoveUI delivers highly customizable components for building modern websites and applications that look and feel exactly right.</p>
                                <p className="mx-auto mt-6 max-w-2xl text-wrap sm:hidden">LoveUI provides customizable components for building modern websites and applications, with your own brand spark.</p>
                                ...
                                <Swiper
                                    ...
                                    <SwiperSlide className="px-2">
                                        <div className="bg-background rounded-(--radius) h-44 max-w-lg border p-9">
                                            ...
                                            <p className="mt-6 text-center text-lg font-medium">30% Faster launch cycles</p>
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide className="px-2">
                                        <div className="bg-background rounded-(--radius) h-44 max-w-lg border p-9">
                                            ...
                                            <p className="mt-6 text-center text-lg font-medium">45% Faster design QA</p>
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide className="px-2">
                                        <div className="bg-background rounded-(--radius) h-44 max-w-lg border p-9">
                                            ...
                                            <p className="mt-6 text-center text-lg font-medium">60% Less UI rework</p>
                                        </div>
                                    </SwiperSlide>
                                </Swiper>
                            </div>
