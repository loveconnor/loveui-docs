...
export function ShaderRipple({
  ...
  const sceneRef = useRef<{
    ...
    uniforms: {
      ...
      lineWidth: { type: string; value: number };
      rippleCount: { type: string; value: number };
      colorLayers: { type: string; value: number };
      rotation: { type: string; value: number };
      timeScale: { type: string; value: number };
      opacity: { type: string; value: number };
      waveIntensity: { type: string; value: number };
      scale: { type: string; value: number };
      color1: { type: string; value: THREE.Vector3 };
      color2: { type: string; value: THREE.Vector3 };
      color3: { type: string; value: THREE.Vector3 };
      loopDuration: { type: string; value: number };
      modValue: { type: string; value: number };
    };
    animationId: number;
  } | null>(null);
