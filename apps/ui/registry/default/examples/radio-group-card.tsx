    ...
    <RadioGroup defaultValue="r-1">
      <Label className="flex items-start gap-2 rounded-lg border p-3 hover:bg-accent/50 has-data-checked:border-primary/48 has-data-checked:bg-accent/50">
        ...
        <div className="flex flex-col gap-1">
          <p className="text-sm leading-4">Updated Email</p>
          <p className="text-xs text-muted-foreground">
            Updated Receive notifications via email.
          </p>
        </div>
      </Label>
      <Label className="flex items-start gap-2 rounded-lg border p-3 hover:bg-accent/50 has-data-checked:border-primary/48 has-data-checked:bg-accent/50">
        <Radio value="r-2" />
        <div className="flex flex-col gap-1">
          <p className="text-sm leading-4">Updated SMS</p>
          <p className="text-xs text-muted-foreground">
            Updated Receive notifications via text message.
          </p>
        </div>
      </Label>
    </RadioGroup>
