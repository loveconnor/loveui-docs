    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground top-[var(--sidebar-top-offset,0px)] h-[calc(100svh-var(--sidebar-top-offset,0px))] w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
...
function SidebarRail({ className, ...props }: ComponentPropsWithoutRef<"button">) {
  const { toggleSidebar } = useSidebar()
...
function SidebarGroupLabel({
  ...
  render,
  ...props
}: useRender.ComponentProps<"div"> & ComponentPropsWithoutRef<"div">) {
  return useRender({
    defaultTagName: "div",
...
function SidebarGroupAction({
  ...
  render,
  ...props
}: useRender.ComponentProps<"button"> & ComponentPropsWithoutRef<"button">) {
  return useRender({
